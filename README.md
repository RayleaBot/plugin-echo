...
`v*` 标签对应的发布工作流使用固定的 RayleaBot SDK 引用构建 Windows x64、Linux x64 和 macOS arm64 包，并创建 GitHub Release。[plugin-catalog](https://github.com/RayleaBot/plugin-catalog) 定时读取当前 Release，校验 artifact 并记录各平台 ZIP 的 SHA-256。
